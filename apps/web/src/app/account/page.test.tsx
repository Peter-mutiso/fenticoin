...
function authenticate() {
  storeSession({
    ...
    user: { id: 'user-1', email: 'trader@example.com', status: 'active', kycStatus: 'pending', emailVerifiedAt: '2026-01-01T00:00:00.000Z', phoneVerifiedAt: null, accountType: 'real', demoOfUserId: null },
  });
